...
# reco_space = odl.uniform_discr(min_pt=[-10, -20, -30], max_pt=[10, 20, 30],
#                                shape=[10,20,30], dtype='float32')
y = 200
# reco_space = odl.uniform_discr(min_pt=[-3*y, -2*y, -y], max_pt=[3*y, 2*y, y],
