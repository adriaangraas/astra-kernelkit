...
_SUPPORTED_IMPL = ('astra_cpu', 'astra_cuda', 'skimage', 'astrapy')
_AVAILABLE_IMPLS = []

_AVAILABLE_IMPLS.append('astrapy')
...
class RayTransform(RayTransformBase):
    ...
    def _call_real(self, x_real, out_real, **kwargs):
        ...
        """
        if self.impl == 'astrapy':
            astra_wrapper = AstrapyProjectorImpl(
        ...
        elif self.impl.startswith('astra'):
...
class RayBackProjection(RayTransformBase):
    ...
    def _call_real(self, x_real, out_real, **kwargs):
        ...
        """
        if self.impl == 'astrapy':
            astra_wrapper = AstrapyBackProjectorImpl(
